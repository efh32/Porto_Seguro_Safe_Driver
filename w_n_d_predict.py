...
def maybe_download(train_data, test_data, test1_data=""):
  ...
  if test1_data:
    ...
    test1_file_name = "processed_test.csv"
...
def predict(model_dir, model_type, train_steps, train_data, test_data):
  ...
  train_output.to_csv(output_dir + "/train_results.csv")
  ...
  test_output.to_csv(output_dir + "/test_results.csv")
  ...
  print(test1_output[:10])
  test1_output.to_csv(output_dir + "/submission.csv") 
